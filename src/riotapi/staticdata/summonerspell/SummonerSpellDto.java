...
public class SummonerSpellDto {
    ...
    public ArrayList<String> get_modes() {
        return modes;
    }

    public void set_modes(ArrayList<String> modes) {
        this.modes = modes;
    }
    ...
    public int get_summonerLevel() {
        return summonerLevel;
    }

    public void set_summonerLevel(int summonerLevel) {
